    ...
    class Selfbot:
        ...
        def command(self, command_name, only_client=True):
            def decorator(func):
                ...
                if content.startswith(self.PREFIX+command_name) and author == username and only_client == True:
                    func(Selfbot(self.TOKEN, self.CHANNEL, self.PREFIX), Command(content, author, id, args))
                elif content.startswith(self.PREFIX+command_name):
                    func(Selfbot(self.TOKEN, self.CHANNEL, self.PREFIX), Command(content, author, id, args))
